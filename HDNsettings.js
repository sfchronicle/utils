...
HDN.dataLayer.content.objectId = `${projectSettings.SUBFOLDER}/${projectSettings.SLUG}`
HDN.dataLayer.content.objectType = 'project'
HDN.dataLayer.content.sectionPath = [
  `${projectSettings.HEARST_CATEGORY}`,
  'special projects',
]
...
exportVar.blendHDN = function(props){
	let blendedHDN = {}
    let stringHDN = ""
